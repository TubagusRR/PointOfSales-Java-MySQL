...
public class FrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnLogin.setFont(new java.awt.Font("Franklin Gothic Demi", 2, 13)); // NOI18N
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        ...
        db.getkoneksi();
        try {
            String sql = "SELECT * FROM tbl_pengguna WHERE username = '" + txtUsername.getText() + "' AND password = '" + txtPassword.getText() + "'";
